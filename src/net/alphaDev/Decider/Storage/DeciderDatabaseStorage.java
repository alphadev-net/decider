 ...
 */
public class DeciderDatabaseStorage
		extends SQLiteOpenHelper
		implements DeciderStorage {
	...
	public void onCreate(SQLiteDatabase mDB) {
		...
		String sql = "CREATE TABLE " + LIST_LABELS + " (ID INTEGER PRIMARY KEY AUTOINCREMENT, LABEL TEXT)";
		mDB.execSQL(sql);

		sql = "CREATE TABLE " + LIST_ENTRIES + " (ID INTEGER PRIMARY KEY AUTOINCREMENT, LABEL INTEGER, ITEM TEXT)";
		mDB.execSQL(sql);
		populateDB(mDB);
	}
	...
	public DecideListAdapter readList(int listID) {
		...
		Collection<CharSequence> tmpList = new ArrayList<CharSequence>();
